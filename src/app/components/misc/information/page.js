    ...
    return(
        <div className="border-y-[0.0625em] border-[#4d4d4d] py-[20px] overflow-hidden"> 
            <div className="max-w-[1150px] mx-auto flex items-center justify-between">
              ...
              className="flex items-center"> <RxGlobe size={32} color="gray"/>
              <span className="font-sans text-sm ml-2 text-[#dcdcdc]">
              ...
              className="flex items-center"> <BsLaptop size={32} color="gray"/>
              <span className="font-sans text-sm ml-2 text-[#dcdcdc]">
              ...
              className="flex items-center"> <AiOutlineCopyright size={32} color="gray"/>
              <span className="font-sans text-sm ml-2 text-[#dcdcdc]">
              <span className="text-purple-500 font-semibold">/</span> WEBDEVCONSULTING <br />ALL RIGHTS RESERVED </span>
              </motion.span>
            </div>
        </div>
