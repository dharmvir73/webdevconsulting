            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
                ...
                <div className="border-x-0 md:border-x-[0.0625em] border-[#4d4d4d] flex flex-col p-4 font-sans h-[75vh] md:h-[90vh]">
                    ...
                    bg-cover rounded-full w-[90%] h-[110%] opacity-40 cursor-pointer transition-all duration-500 ease-in-out hover:opacity-100">
                        ...
                        {/** Service 5 */}
                <div className="flex flex-col p-4 font-sans h-[75vh] md:h-[90vh] border-[#4d4d4d] border-t-[0.0625em] md:border-t-0">
                    ...
                    bg-cover rounded-full w-[90%] h-[110%] opacity-40 cursor-pointer transition-all duration-500 ease-in-out hover:opacity-100">
                        ...
                        {/** Service 6 */}
                <div className="border-x-0 md:border-t-0 border-t-[0.0625em] md:border-x-[0.0625em] border-[#4d4d4d] 
