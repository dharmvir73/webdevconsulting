...
const Contact = () => {
    ...
    return(
        <div className="max-w-[1150px] mx-auto border-x-[0.0625em] border-[#4d4d4d] text-sm md:text-lg">
            <div className="md:flex-row md:text-left gap-8 text-center flex flex-col items-center justify-between text-[#d3d3d3]
            transition-all duration-500 ease-in-out hover:text-3xl hover:text-purple-500 py-5 md:py-20 px-5">
            ...
            <div className="md:flex-row md:text-left  gap-8 text-center flex flex-col items-center justify-between text-[#d3d3d3] 
             transition-all duration-500 ease-in-out hover:text-3xl hover:text-purple-500 py-5 md:py-20 px-5  border-t-[0.0625em] border-[#4d4d4d]">
